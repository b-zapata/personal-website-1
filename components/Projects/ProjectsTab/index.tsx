...
import projectsTabData from "./projectsTabData";
    ...
    <>
      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {projectsTabData.map((project, key) => (
              <div
                className={project.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <ProjectsTabItem projectTab={project} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
