...
import ExperiencesTabItem from "./ExperiencesTabItem";
import experiencesTabData from "./experiencesTabData";
        ...
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {experiencesTabData.map((experience, key) => (
              <div
                className={experience.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <ExperiencesTabItem experienceTab={experience} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
