...
const experiencesTabData: ExperienceTab[] = [
  {
    id: "tabOne",
    experiences: [
      {
  ...
  },
  {
    ...
    experiences: [
      ...
      },
      {
        startDate: "",
        endDate: "",
        title: "Marriott School Dean's List, Sophomore Year",
        employer: "Marriott School of Business—Brigham Young University",
        logo: "/images/logo/byu-marriott-logo_3.png",
        location: "Provo, UT",
        bulletPoint1: "",
        bulletPoint2: "",
        bulletPoint3: "",
...
export default experiencesTabData;
