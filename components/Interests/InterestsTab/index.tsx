...
import InterestsTabItem from "./InterestsTabItem";
import interestsTabData from "./interestsTabData";
    ...
    <>
      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            {interestsTabData.map((interest, key) => (
              <div
                className={interest.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <InterestsTabItem interestTab={interest} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
